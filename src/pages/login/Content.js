          ...
          <div className="costumer-area">
            ...
            <div className="app-download">
              <a href="https://play.google.com/store/apps/details?id=br.com.santander.benvisavale&hl=pt_BR">
                <Image src="/public/svg/google-play.svg" width={120} height={40} alt="Disponível no Google Play" />
              </a>
              <a href="https://apps.apple.com/br/app/ben-visa-vale/id1426592452">
                <Image src="/public/svg/apple-store.svg" width={110} height={40} alt="Baixar na App Store" />
              </a>
            </div>
          </div>
        </div>
        ...
        <footer className="login-footer">
          ...
          <div className="ben-network">
            <a href="https://www.facebook.com/benvisavale/">
              <Image src="/public/svg/icon-facebook.svg" width={32} height={32} alt="Facebook" />
            </a>
            <a href="https://www.instagram.com/benvisavale/?hl=pt-br">
              <Image src="/public/svg/icon-instagram.svg" width={32} height={32} alt="Instagram" />
            </a>
            <a href="https://www.linkedin.com/company/benvisavale/">
              <Image src="/public/svg/icon-linkedin.svg" width={32} height={32} alt="Linkedin" />
            </a>
          </div>
        </footer>
